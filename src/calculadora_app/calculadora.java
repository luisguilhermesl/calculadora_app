...
public class calculadora extends javax.swing.JFrame {
    ...
    public void operacoes_aritmeticas() {
        ...
        switch (calcular) {
            ...
            case 1: // Soma / Adição
                resultado = numero + Double.parseDouble(visualizador.getText());
                visualizador.setText(Double.toString(resultado));
                break;
    ...
    private void initComponents() {
        ...
        visualizador.setBackground(new java.awt.Color(204, 204, 204));
        visualizador.setFont(new java.awt.Font("Consolas", 1, 24)); // NOI18N
        visualizador.setForeground(new java.awt.Color(0, 0, 0));
        visualizador.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        int length = visualizador.getText().length();
        int num = visualizador.getText().length() - 1;
        String armazenamento;

        if (length > 0) {
            StringBuilder backSpace = new StringBuilder(visualizador.getText());
            backSpace.deleteCharAt(num);
            armazenamento = backSpace.toString();
